...
Wujudkan Kota yang Lebih Baik Bersama
...
Laporkan permasalahan fasilitas umum,
lingkungan, dan pelayanan publik secara
cepat, transparan, dan terintegrasi.

Setiap laporan dipantau hingga selesai
...
secara real-time sampai selesai.
...
`,
    ...
    <span id="reportedCount"></span>
    <span id="verifiedCount"></span>
    <span id="progressCount"></span>
    <span id="resolvedCount"></span>
...
if(hash === '#home'){
    ...
    if(typeof loadPublicFeedPreview === 'function'){
        loadPublicFeedPreview();
    }
